...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            if (convertView == null){
                ...
                convertView = inflater2.inflate(R.layout.listvew_comment, parent, false);
            }
        }
        ...
        titleTextview.setText(listview_custom.getcontent_Title());
        ...
        TextView c_date = (TextView) convertView.findViewById(R.id.c_date);
        TextView c_comment = (TextView) convertView.findViewById(R.id.c_comment);

        c_name.setText(listview_custom.getC_name());
        c_date.setText(listview_custom.getC_date());
        c_comment.setText(listview_custom.getC_comment());
    ...
    public void addComment(String c_name, String c_date, String c_comment ){
        listview_custom item = new listview_custom();

        item.setC_name(c_name);
        item.setC_date(c_date);
        item.setC_comment(c_comment);
